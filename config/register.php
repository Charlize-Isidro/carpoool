...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlchar = "INSERT INTO userinfo (UserLevel, FirstName, LastName, ContactNum, Email, Password, Street, UnitNum, Baranggay, Municipality, ZipCode, Province) VALUES ('$type', '$fname', '$lname', '$contact_no', '$email', '$password','$st', '$unitnum', '$barangay', '$municipality', '$zipcode', '$province')";
    $query = mysqli_query($connection, $sqlchar);
